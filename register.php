          ...
          <div class="col-md-6 col-lg-4">
            <div class="login-wrap p-0">
              ...
              <form action="#" class="signin-form" method="post">
                ...
                <div class="form-group">
                  <button type="submit" name="bsubmit" class="form-control btn btn-primary submit px-3">Register</button>
                </div>
                <div class="form-group d-md-flex">
                  <div class="forgot">
                    <a href="login.php" style="color: #fff; margin-left: 7.4rem;">Log in Now !</a>
                  </div>
                </div>
              </form>
            </div>
